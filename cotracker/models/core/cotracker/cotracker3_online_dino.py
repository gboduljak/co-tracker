...
from cotracker.models.core.cotracker.dino import DINOFeatureExtractor
...
class CoTrackerThreeBase(nn.Module):
    def __init__(
        ...
        dino="/scratch/shared/beegfs/gabrijel/hf/models--facebook--dinov2-large/snapshots/47b73eefe95e8d44ec3623f8890bd894b6ea2d6c",
        dino_channels=1024,
        freeze_dino=True,
        refine_dino=False,
        ...
        self.dino = DINOFeatureExtractor(
            ...
            resize_height=336,
            resize_width=448,
            target_height= h // stride,
            target_width=w // stride,
            freeze_dino=freeze_dino,
            dino_dim=dino_channels,
            feature_dim=self.latent_dim,
            refine_dino=refine_dino,
            dino_intermediate_features_idx=dino_intermediate_features_idx,
        ...
        self.updateformer = EfficientUpdateFormer(
            ...
            ckpt_every_other=gradient_checkpointing
        )
